...
-- ENTITY USER TABLE:
CREATE TABLE entity_user( id INT NOT NULL AUTO_INCREMENT, entity_user_id VARCHAR(255) NOT NULL, entity_id 	VARCHAR(255) NOT NULL, user_id VARCHAR(255) NOT NULL, entity_type VARCHAR(255) NOT NULL, active_from VARCHAR(255) NULL, active_to VARCHAR(255) NULL, entity_status VARCHAR(255) NOT NULL, roles VARCHAR(255) NOT NULL, is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));
...
-- REPOSITORY TABLE:
CREATE TABLE repository(id INT NOT NULL AUTO_INCREMENT, repo_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1024) NULL, owner VARCHAR(255) NOT NULL, is_public INT NOT NULL, entity_id VARCHAR(255) NOT NULL,  is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));
