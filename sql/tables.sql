...
-- REPO_LINK TABLE:
CREATE TABLE repo_link(id INT NOT NULL AUTO_INCREMENT, repo_id VARCHAR(255) NOT NULL, link VARCHAR(1024) NOT NULL, dir_name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, path VARCHAR(1024) NOT NULL, is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));
...
CREATE TABLE label_studio_project(id INT NOT NULL AUTO_INCREMENT, ls_id VARCHAR(32) NOT NULL, subset_id VARCHAR(32) NOT NULL, entity_id VARCHAR(32) NOT NULL, ls_project_id VARCHAR(32) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1024) NULL, is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));

-- LABEL STUDIO IMPORT STORAGE  
CREATE TABLE ls_import_storage(id INT NOT NULL AUTO_INCREMENT, import_storage_id VARCHAR(255) NOT NULL, ls_id VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, project_id VARCHAR(255) NOT NULL, subset_id VARCHAR(255) NOT NULL, entity_id VARCHAR(255) NULL, user_id VARCHAR(255) NULL, path VARCHAR(255) NOT NULL, is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));
...
--SUBSET
CREATE TABLE subset(id INT NOT NULL AUTO_INCREMENT, subset_id VARCHAR(255) NOT NULL, dataset_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1024) NULL, owner VARCHAR(255) NOT NULL, is_public INT NOT NULL, path VARCHAR(255) NOT NULL,  is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));

-- SUBSET ITEM
CREATE TABLE subset_item(id INT NOT NULL AUTO_INCREMENT, subset_item_id VARCHAR(255) NOT NULL, subset_id VARCHAR(255) NOT NULL, name VARCHAR(1024) NOT NULL, path VARCHAR(255) NOT NULL, type VARCHAR(32) NOT NULL,  is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));
...
CREATE TABLE trims(id INT NOT NULL AUTO_INCREMENT, trim_id VARCHAR(255) NOT NULL, ground_truth_id VARCHAR(255) NOT NULL, video_id VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, type VARCHAR(255) NULL, is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));


-- AOLME_DAO DATABASE:  DATASTORE SUBSET --- THIS IS DIFFERENT FROM SUBSET TABLE
CREATE TABLE datastore_subset(id INT NOT NULL AUTO_INCREMENT, datastore_id VARCHAR(255) NOT NULL, ds_subset_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1024) NULL, type VARCHAR(255) NOT NULL, owner VARCHAR(255) NOT NULL, is_public INT NOT NULL, path VARCHAR(255) NOT NULL,  is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));

CREATE TABLE datastore_subset_item(id INT NOT NULL AUTO_INCREMENT, ds_subset_item_id VARCHAR(255) NOT NULL, ds_subset_id VARCHAR(255) NOT NULL, name VARCHAR(1024) NOT NULL, path VARCHAR(255) NOT NULL, type VARCHAR(32) NOT NULL,  is_active INT NOT NULL, created_by VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, updated_by VARCHAR(255) NULL, updated_at VARCHAR(255) NULL, deleted_by VARCHAR(255) NULL, deleted_at VARCHAR(255) NULL, PRIMARY KEY(id));
