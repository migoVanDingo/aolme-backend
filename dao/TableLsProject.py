...
class TableLsProject:
    ...
    def read_ls_project_by_id(self, ls_project_id):
        try:
            query = "SELECT * FROM ls_project WHERE is_active = 1 AND ls_project_id = %s"
            cur = self.db.connection.cursor()
